...
- 安装ThinkORM
  ...
  > [`webman/think-orm`](https://www.workerman.net/plugin/14) 实际上是一个自动化安装并配置 `toptink/think-orm` 的插件，如果你的webman版本低于1.2请参考文章[手动配置think-orm](https://www.workerman.net/a/1289)。
